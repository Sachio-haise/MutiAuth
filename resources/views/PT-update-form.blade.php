        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <h3>Fill In The Data For Phone And Tablet Below.</h3>
                    <form  method="post" action="{{route('admin.PT-update',[$PT->id])}}" enctype="multipart/form-data">
                        @csrf
                        @if(session('status'))
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="model" placeholder="Enter Model Name" value="{{$PT->model}}" style="margin-bottom: .8rem;">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="brand" placeholder="Enter Brand" value="{{$PT->brand}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="screensize" placeholder="Enter Screen Size" value="{{$PT->screensize}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="operationsystem" placeholder="Enter Operation System " value="{{$PT->operationsystem}}" >

                            @error('operationsystem')
                            <p style="color:red;font-weight: 600;margin-top: .8rem;">{{$message}}</p>
                            @enderror
                        </div>

                        <div class="col-md-12">
                            <input class="form-control" type="text" name="storage" placeholder="Enter Memory Storage Capacity" value="{{$PT->storage}}" >
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="number" name="price" placeholder="Enter Price" value="{{$PT->price}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modaltitle" placeholder="Modal Title" value="{{$PT->modaltitle}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modalbrand" placeholder="Modal Brand" value="{{$PT->modalbrand}}">
