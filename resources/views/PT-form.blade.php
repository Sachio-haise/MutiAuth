        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form  method="post" action="{{route('admin.PT-store')}}" enctype="multipart/form-data">
                        @csrf
                        @if(session('status'))
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="model" placeholder="Enter Model Name" value="{{ old('model') }}" style="margin-bottom: .8rem;">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="brand" placeholder="Enter Brand" value="{{ old('brand') }}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="screensize" placeholder="Enter Screen Size" value="{{ old('screensize') }}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="operationsystem" placeholder="Enter Operation System " value="{{ old('operationsystem') }}" >
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="storage" placeholder="Enter Memory Storage Capacity" value="{{ old('storage') }}" >
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="number" name="price" placeholder="Enter Price" value="{{ old('price') }}">
