...
<head>
    ...
    <style>
        ...
        @media(min-width:990px){ .navbar .navbar-nav{ margin-left: 45rem;} }
        ...
        <div class="col-12  col-lg-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                    <li><a class="dropdown-item active" href="{{route('admin.laptop-create')}}">Laptop</a></li>
                    <li><a class="dropdown-item" href="{{route('admin.desktop-create')}}">Desktop</a></li>
                    <li><a class="dropdown-item" href="{{route('admin.PT-create')}}">Phone & Tablet</a></li>
                    <li><a class="dropdown-item" href="{{route('admin.accessory-create')}}">Accessory</a></li>
                </ul>
            </div>
            ...
            @foreach($laptops as $laptop)
                ...
                <div class="card" data-name="laptop" style="position: relative">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{url('/admin/laptop-edit/'.$laptop->id)}}" class="btn btn-warning mb-1">Edit</a>
                        <a href="{{route('admin.laptop-delete',[$laptop->id])}}" class="btn btn-danger mb-1" >Delete</a>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="{{'#gg'.$laptop->id}}">
                            Read More
                        </button>
                    </div>
                </div>
            ...
            @foreach($desktops as $desktop)
                ...
                <div class="card" data-name="desktop">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{url('/admin/desktop-edit/'.$desktop->id)}}" class="btn btn-warning mb-1">Edit</a>
                        <a href="{{route('admin.desktop-delete',[$desktop->id])}}" class="btn btn-danger mb-1" >Delete</a>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="{{'#gg'.$desktop->id}}">
                            Read More
                        </button>
                    </div>
                </div>
            ...
            @foreach($PTs as $PT)
                ...
                <div class="card" data-name="tablet">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Modal - {{$PT->modal}} GB</p>
                        ...
                        <a href="{{url('/admin/desktop-edit/'.$PT->id)}}" class="btn btn-warning mb-1">Edit</a>
                        <a href="{{route('admin.desktop-delete',[$PT->id])}}" class="btn btn-danger mb-1" >Delete</a>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="{{'#gg'.$PT->id}}">
                           Read More
                        </button>
                    </div>
                </div>
            ...
            @foreach($Accessories as $accessory)
                ...
                <div class="card" data-name="accessory">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{url('/admin/desktop-edit/'.$accessory->id)}}" class="btn btn-warning mb-1">Edit</a>
                        <a href="{{route('admin.desktop-delete',[$accessory->id])}}" class="btn btn-danger mb-1" >Delete</a>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="{{'#gg'.$accessory->id}}">
                            Read More
                        </button>
                    </div>
                </div>
