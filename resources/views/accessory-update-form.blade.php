        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <h3>Fill In The Data For Electronic Accessory Below.</h3>
                    <form  method="post" action="{{route('admin.accessory-update',[$accessory->id])}}" enctype="multipart/form-data">
                        @csrf
                        @if(session('status'))
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="model" placeholder="Enter Model Name" value="{{ $accessory->model}}" style="margin-bottom: .8rem;">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="brand" placeholder="Enter Brand" value="{{ $accessory->brand}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="colour" placeholder="Enter colour" value="{{ $accessory->colour}}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="number" name="price" placeholder="Enter Price" value="{{ $accessory->price }}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modaltitle" value="{{ $accessory->modaltitle }}" placeholder="Modal Title" >
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modalbrand" value="{{ $accessory->modalbrand}}" placeholder="Modal Brand" >
