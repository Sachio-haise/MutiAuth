            ...
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form  method="post" action="{{route('admin.accessory-store')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="colour" placeholder="Enter colour" value="{{ old('colour') }}">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modaltitle" value="{{ old('modaltitle') }}" placeholder="Modal Title" >
                        ...
                        <div class="col-md-12">
                            <input class="form-control" type="text" name="modalbrand" value="{{ old('modalbrand') }}" placeholder="Modal Brand" >
